...
function CALL_RB_MM (preferences, originalPreferences, device, solutions, wrap) {
	...
	client.get(wsPath, wrap(function(data, response){
			...
			for(i=0; i<newPrefsWords.length;i++)
			{
				...
				else if(newPrefsWords[i].indexOf(tomcat_html_URL_prefix + "/RBMM/RBMMFeedbackEnglish_") != -1)
				{
					feedbackEnglishFileURL = newPrefsWords[i];
				}				
				else if(newPrefsWords[i].indexOf(tomcat_html_URL_prefix + "/RBMM/RBMMFeedbackGerman_") != -1)
				{
					feedbackGermanFileURL = newPrefsWords[i];
				}
				else if(newPrefsWords[i].indexOf(tomcat_html_URL_prefix + "/RBMM/RBMMFeedbackGreek_") != -1)
				{
					feedbackGreekFileURL = newPrefsWords[i];
				}
				else if(newPrefsWords[i].indexOf(tomcat_html_URL_prefix + "/RBMM/RBMMFeedbackSpanish_") != -1)
				{
