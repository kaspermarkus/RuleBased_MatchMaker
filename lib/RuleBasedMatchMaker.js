			...
			for(i=0; i<newPrefsWords.length;i++)
			{
				...
				else if(newPrefsWords[i] === "OPEN_VOLUME")
				{
					if(preferences!=null && preferences.applications!=null && preferences.applications["org.alsa-project"]==null)
						preferences.applications["org.alsa-project"] = { id: "org.alsa-project", parameters: { masterVolume: 100 } };
				}
				...
				{
					if(preferences!=null && preferences.applications==null) 
					{
						preferences.applications = {};
						preferences.applications["webinsight.webAnywhere.windows"] = { id: "webinsight.webAnywhere.windows", parameters: { locale: "en", starting_url: "http://www.bnl.public.lu/fr/index.html" } };
					}
					else if(preferences!=null && preferences.applications!=null && preferences.applications["webinsight.webAnywhere.windows"]==null)
					{
						preferences.applications["webinsight.webAnywhere.windows"] = { id: "webinsight.webAnywhere.windows", parameters: { locale: "en", starting_url: "http://www.bnl.public.lu/fr/index.html" } };
					}
				}
